...
public class TicTacToeAlternate extends JFrame {
  // Anfang Attribute
  ...
  public TicTacToeAlternate(String title) {
  ...
  public void buttons00_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[0][0].getActionListeners();
        buttons[0][0].removeActionListener(al[0]);
        feld[0][0]=player;
        player++;
  ...
  public void buttons01_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[0][1].getActionListeners();
        buttons[0][1].removeActionListener(al[0]);
        feld[0][1]=player;
        player++;
        jLB_Ausgabe.setText("Spieler 2 ist dran");
      }
  ...
  public void buttons02_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[0][2].getActionListeners();
        buttons[0][2].removeActionListener(al[0]);
        feld[0][2]=player;
        player++;
        jLB_Ausgabe.setText("Spieler 2 ist dran");
      }
  ...
  public void buttons10_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[1][0].getActionListeners();
        buttons[1][0].removeActionListener(al[0]);
        feld[1][0]=player;
        player++;
        jLB_Ausgabe.setText("Spieler 2 ist dran");
      }
  ...
  public void buttons11_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[1][1].getActionListeners();
        buttons[1][1].removeActionListener(al[0]);
        feld[1][1]=player;
        player++;
        jLB_Ausgabe.setText("Spieler 2 ist dran");
      }
  ...
  public void buttons12_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[1][2].getActionListeners();
        buttons[1][2].removeActionListener(al[0]);
        feld[1][2]=player;
        player++;
        jLB_Ausgabe.setText("Spieler 2 ist dran");
      }
  ...
  public void buttons20_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[2][0].getActionListeners();
        buttons[2][0].removeActionListener(al[0]);
        feld[2][0]=player;
        player++;
        jLB_Ausgabe.setText("Spieler 2 ist dran");
      }
  ...
  public void buttons21_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[2][1].getActionListeners();
        buttons[2][1].removeActionListener(al[0]);
        feld[2][1]=player;
        player++;
        jLB_Ausgabe.setText("Spieler 2 ist dran");
      }
  ...
  public void buttons22_ActionPerformed(ActionEvent evt) {
    if(runs){
      if(player==1){
        ...
        ActionListener al[]=buttons[2][2].getActionListeners();
        buttons[2][2].removeActionListener(al[0]);
        feld[2][2]=player;
        player++;
        jLB_Ausgabe.setText("Spieler 2 ist dran");
      }
  ...
  public static void main(String[] args) {
    new TicTacToeAlternate("TicTacToeAlternate");
  }
}
