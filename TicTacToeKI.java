...
public class TicTacToeKI extends JFrame {
  // Anfang Attribute
  public JButton jBTN_Start = new JButton();
  public int player=1;
  public JLabel jLB_Ausgabe = new JLabel();
  ...
  public TicTacToeKI(String title) {
